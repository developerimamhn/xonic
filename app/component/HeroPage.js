            ...
            <div data-layer="Frame 14" className="Frame14 ml-[24px] sm:ml-[180] md:ml-[230px] lg:ml-[280px] xl:ml-[330px] 2xl:ml-[380px] flex flex-row justify-start items-start gap-[50px] sm:gap-[100px] xl:gap-[122px]">
                <div  className='inline-flex flex-col gap-[]'>
                    <div data-layer="Frame 13" className="Frame13 self-stretch flex flex-col justify-start items-start gap-[16px]  sm:gap-[20px] xl:gap-[32px]">
                        <div ref={textRef} data-layer="Trade Like a Pro with Xonic Capital " className="TradeLikeAProWithXonicCapital text-[32px] sm:text-[36px] md:text-[40px] lg:text-[48px] xl:text-[64px] 2xl:text-[84px]">
                    ...
                    <div ref={buttonRef} data-layer="Frame 12" className="Frame12 size- inline-flex justify-start items-center gap-3 pt-[16px] sm:pt-[20px] md:pt-[24px] lg:pt-[32px] xl:pt-[36px] 2xl:pt-[40px]">
                ...
                <Image ref={imageRef} className=" w-[40%] sm:relative absolute right-0 bottom-0" src={imagesrc} alt="Loading..." />
            </div>
        </div>
        </div>
    );

    ...
    return (
        <div className='pt-[36px] sm:pt-[40px] md:pt-[48px] lg:pt-[64px] xl:pt-[96px] 2xl:pt-[148px] container mx-auto pb-[32px] sm:pb-[36px] md:pb-[40px] lg:pb-[48px] xl:pb-[64px] 2xl:pb-[99px] px-[24px] sm:px-0'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-9 px-[24px] sm:px-[50px] md:px-[80px] lg:px-[120px] xl:px-[160px] 2xl:px-[193px] gap-[13px] sm:gap-[14px] md:gap-[15px] lg:gap-[16px] xl:gap-[20px] 2xl:gap-[24px] pt-[13px] sm:pt-[14px] md:pt-[15px] lg:pt-[16px] xl:pt-[20px] 2xl:pt-[24px]'>
                ...
                <mask id="path-11-inside-1_1168_1182" fill="white">
                ...
                <path d="M45.991 34.5457L46.251 34.4748L46.2473 34.4631L45.991 34.5457ZM45.72 34.1683L45.5603 34.3851L45.5603 34.3851L45.72 34.1683ZM45.2817 34.0234L45.2823 33.7542H45.2817V34.0234ZM38.1787 34.0234V33.7542L38.178 33.7542L38.1787 34.0234ZM37.7403 34.1683L37.5807 33.9515L37.5807 33.9515L37.7403 34.1683ZM37.4693 34.5457L37.2128 34.4631L37.2095 34.4751L37.4693 34.5457ZM47.7249 39.8829L46.2507 34.4749L45.7312 34.6165L47.2054 40.0245L47.7249 39.8829ZM46.2473 34.4631C46.1813 34.2582 46.0528 34.079 45.8796 33.9515L45.5603 34.3851C45.6419 34.4452 45.7031 34.5301 45.7347 34.6282L46.2473 34.4631ZM45.8796 33.9515C45.7064 33.824 45.4974 33.7547 45.2823 33.7542L45.281 34.2927C45.3811 34.2929 45.4788 34.3251 45.5603 34.3851L45.8796 33.9515ZM45.2817 33.7542H38.1787V34.2927H45.2817V33.7542ZM38.178 33.7542C37.963 33.7547 37.754 33.824 37.5807 33.9515L37.9 34.3851C37.9815 34.3251 38.0793 34.2929 38.1793 34.2927L38.178 33.7542ZM37.5807 33.9515C37.4075 34.079 37.2791 34.2582 37.2131 34.4631L37.7256 34.6282C37.7572 34.5301 37.8184 34.4451 37.9 34.3851L37.5807 33.9515ZM37.2095 34.4751L35.7402 39.8831L36.2598 40.0243L37.7292 34.6163L37.2095 34.4751Z" fill="white" mask="url(#path-13-inside-2_1168_1182)"/>
                <path d="M51.6997 40.0808C51.652 39.9289 51.5577 39.7964 51.431 39.7025C51.304 39.6086 51.1512 39.5583 50.9945 39.5586H43.9323C43.7758 39.5584 43.6233 39.6089 43.4969 39.7028C43.3706 39.7967 43.2769 39.9291 43.2295 40.0808L41.9509 44.908C41.9297 44.9746 41.9243 45.0454 41.9351 45.1145C41.9459 45.1837 41.9727 45.2492 42.0131 45.3058C42.0536 45.3625 42.1067 45.4086 42.168 45.4404C42.2293 45.4722 42.2971 45.4888 42.3659 45.4888H52.5632C52.6322 45.4888 52.7001 45.4722 52.7613 45.4404C52.8226 45.4086 52.8757 45.3625 52.916 45.3058C52.9565 45.2492 52.9832 45.1837 52.994 45.1145C53.0048 45.0454 52.9994 44.9746 52.9784 44.908L51.6997 40.0808Z" fill="white" fill-opacity="0.1" stroke="white" stroke-miterlimit="10"/>
                <path d="M45.8828 32.0467L46.2782 29.2793L45.8828 32.0467Z" fill="white" fill-opacity="0.1"/>
                <path d="M45.8828 32.0467L46.2782 29.2793" stroke="white" stroke-width="0.269231" stroke-linecap="round"/>
                ...
                <path d="M47.0703 33.6286L50.2331 32.8379L47.0703 33.6286Z" fill="white" fill-opacity="0.1"/>
                <path d="M47.0703 33.6286L50.2331 32.8379" stroke="white" stroke-width="0.269231" stroke-linecap="round"/>
                <path d="M52.8661 28.0931C52.8661 28.8921 52.2183 29.5399 51.4193 29.5399C50.6203 29.5399 49.9725 28.8921 49.9725 28.0931C49.9725 27.2941 50.6203 26.6463 51.4193 26.6463C52.2183 26.6463 52.8661 27.2941 52.8661 28.0931Z" fill="white" fill-opacity="0.1" stroke="white" stroke-width="0.269231"/>
                <path d="M46.6738 28.4891V28.0938V28.4891Z" fill="white" fill-opacity="0.1"/>
                <path d="M46.6738 28.4891V28.0938" stroke="white" stroke-width="0.269231" stroke-linecap="round"/>
                </svg>
